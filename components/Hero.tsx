...
export function Hero() {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center pt-32 pb-20 px-4 md:px-24 bg-warm-sand relative">
      {/* Decorative Elements */}
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 w-full max-w-7xl z-10 mb-20">
        <motion.div
        ...
        >
          ...
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-serif font-black text-rich-charcoal leading-[1.1] tracking-tighter">
            Reading is <span className="hidden md:inline"><br /></span>
            <span className="text-forest-green underline decoration-watermelon-pink decoration-8 underline-offset-8 italic">Better</span> Together.
          </h1>

          <p className="text-lg md:text-2xl font-sans text-rich-charcoal/80 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
