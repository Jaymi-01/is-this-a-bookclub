      ...
      <div className="max-w-md w-full bg-parchment p-12 rounded-[2.5rem] border-4 border-rich-charcoal shadow-[16px_16px_0px_#1A1A1A]">
        <div className="flex justify-center mb-8">
          <BookOpen
            size={80}
            weight="fill"
            className="text-forest-green animate-bounce"
          />
        </div>
        <h1 className="text-6xl md:text-8xl font-serif font-black text-rich-charcoal mb-4">
          404
        </h1>
        <h2 className="text-2xl font-bold text-rich-charcoal mb-6 uppercase tracking-tight">
          Chapter Not Found
        </h2>
        <p className="text-rich-charcoal/60 font-medium mb-10 leading-relaxed">
          It seems you&apos;ve wandered into a blank page. This chapter
          hasn&apos;t been written yet, or maybe it was lost in the library.
        </p>
        <Link
          href="/"
